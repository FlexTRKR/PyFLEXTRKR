...
def identifymcs_tb(statistics_filebase, stats_path, startdate, enddate, \
                    geolimits, time_resolution, area_thresh, duration_thresh, eccentricity_thresh, \
                    split_duration, merge_duration, nmaxmerge, timegap=1):
    # Inputs:
