...
if __name__ == "__main__":
    ...
    plot_info = {
        ...
        'levels': np.arange(-3e7, 3.01e7, 0.5e6),  # shading levels
        'cbticks': np.arange(-3e7, 3.01e7, 1e7),  # colorbar ticks
        'cblabels': '600hPa PSI Anomaly',  # colorbar label
        'marker_size': 6,   # track symbol marker size
