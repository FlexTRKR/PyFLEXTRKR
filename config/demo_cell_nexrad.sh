...
python ../Analysis/plot_subset_cell_tracks_demo.py -s '2014-08-07T12' -e '2014-08-07T15' -c ${config_demo} --radar_lat 29.4719 --radar_lon -95.0787 -p 1 --figsize 8 7 --output ${quicklook_dir}
