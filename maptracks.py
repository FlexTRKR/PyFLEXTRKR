...
#        allsplitmap = allsplitmap.astype(np.int32)
    ...
    trackmaps_outfile = tracking_path + 'tracks_' + str(filedate) + '_' + str(filetime) + '.nc'
    ...
    if showalltracks == 1:
        ...
        output_data.to_netcdf(path=trackmaps_outfile, mode='w', format='NETCDF4_CLASSIC', unlimited_dims='time', \
