...
#SBATCH --exclusive
#SBATCH --output=log_gpm_mcs_saag_2010_2011.log
...
# python ./runscripts/run_mcs_tbpf.py ./config/config_gpm_mcs_saag_cu2_2010_2011.yml $scheduler_file $n_tasks
python ./runscripts/run_mcs_tbpf.py ./config/config_gpm_mcs_saag_cu2_2010_2011.yml
