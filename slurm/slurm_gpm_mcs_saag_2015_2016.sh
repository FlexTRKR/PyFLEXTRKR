...
#SBATCH --exclusive
#SBATCH --output=log_gpm_mcs_saag_2015_2016.log
...
# python ./runscripts/run_mcs_tbpf.py ./config/config_gpm_mcs_saag_cu2_2015_2016.yml $scheduler_file $n_tasks
python ./runscripts/run_mcs_tbpf.py ./config/config_gpm_mcs_saag_cu2_2015_2016.yml
