...
def write_trackstats_ct(trackstats_outfile, numtracks, maxtracklength, numcharfilename, \
                        datasource, datadescription, startdate, enddate, \
                        track_version, tracknumbers_version, timegap, \
        ...
        output_data.cloudtype_npix_conglow.attrs['long_name'] = 'Number of pixels labeled as low congestus cloud in a track'
        output_data.cloudtype_npix_conglow.attrs['units'] = 'unitless'
        
        output_data.cloudtype_npix_conghigh.attrs['long_name'] = 'Number of pixels labeled as high congestus cloud in a track'
        output_data.cloudtype_npix_conghigh.attrs['units'] = 'unitless'
        
        output_data.cloudtype_npix_deep.attrs['long_name'] = 'Number of pixels labeled as deep cloud in a track'
