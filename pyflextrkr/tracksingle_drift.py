...
def trackclouds(zipped_inputs): 
    ...
    if hour_diff < timegap and hour_diff > 0:
        ...
        if (reference_filedatetime == datetime_drift):
            ...
            reference_convcold_cloudnumber = ndi.shift(ref_cn, [0, ydrift, xdrift])
        else:
            print('Warning: datetime_drift does NOT match reference_filedatetime! No shifting is applied.')
